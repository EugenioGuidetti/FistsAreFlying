...
public class Shield2 : MonoBehaviour {
	...
	void Start () {
		...
		wallUpPosition= GameObject.Find("Wall_up2").GetComponent<Transform>().position.y;
		wallDownPosition= GameObject.Find("Wall_down2").GetComponent<Transform>().position.y;
		wallOffset= GameObject.Find("Wall_down2").GetComponent<Transform>().localScale.y*2;
	}
